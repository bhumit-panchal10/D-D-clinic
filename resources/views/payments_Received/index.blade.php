                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('paymentsreceived.store') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        <label for="mode" class="form-label">Payment Mode<span
                                                class="text-danger">*</span></label>
                    ...
                    <div class="col-lg-7">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title mb-0">Payments Received List</h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-sm btn-primary edit-btn"
                                                        onclick="getEditData(<?= $payment->id ?>)" data-bs-toggle="modal"
                                                        data-bs-target="#editNoteModal">
                                                        Edit
                                                    </button>
                                                    <button type="button" class="btn btn-sm btn-primary delete-btn"
                                                        data-id="{{ $payment->id }}"
                                                        data-patient-id="{{ $payment->patient_id }}" data-toggle="modal"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Payment Received</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="editForm" method="POST" action="{{ route('paymentsreceived.update') }}">
                        @csrf
                        ...
                        <div class="mb-3">
                            <label for="amount" class="form-label">Discount<span class="text-danger">*</span></label>
...
@section('scripts')
    ...
    <script>
        function getEditData(id) {
            ...
            var url = "{{ route('paymentsreceived.edit', ':id') }}";
    ...
    <script>
        $(document).ready(function() {
            $(".delete-btn").on("click", function() {
                ...
                let actionUrl = "{{ route('paymentsreceived.destroy', ':id') }}".replace(':id', id);
