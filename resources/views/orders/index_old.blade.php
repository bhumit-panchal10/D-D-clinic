                    ...
                    <div class="card-body">
                        <table class="table table-bordered">
                            ...
                            <tfoot class="table-light">
                                ...
                                <!--        @if ($totalDue > 0)-->
                                <!--            <button class="btn btn-primary btn-sm"-->
                                <!--                onclick="openGlobalPaymentModal({{ $totalDue }})">-->
                                <!--                Make Payment-->
                                <!--            </button>-->
                                <!--        @endif-->
                                <!--    </th>-->
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('payments.store') }}" method="POST" onsubmit="return validatePaymentAmount();">
                    ...
                    <div class="modal-body">
                        ...
                        {{-- NEW: choose an order when coming from the totals button --}}
                        <div class="mb-3" id="orderPickerRow" style="display:none;">
                            <label class="form-label">Select Invoice</label>
                            <select class="form-select" id="payment_order_picker">
                                <option value="" disabled selected>Choose an invoice</option>
                                @foreach ($dueOrders as $o)
                                    @php
                                        $oPaid = $o->payments()->sum('amount');
                                        $oDue = max(0, $o->amount - $oPaid);
                                    @endphp
                                    <option value="{{ $o->id }}" data-due="{{ $oDue }}">
                                        #{{ $o->invoice_no }} — Due: {{ number_format($oDue, 2) }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
