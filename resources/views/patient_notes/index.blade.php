                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('patient_notes.store', $patient->id) }}" method="POST"
                                            ...
                                            @csrf
                                            <input type="hidden" id="patient_treatment_id" name="patient_treatment_id"
                                                value="">
                                            <div class="mb-3">
                                                <label class="form-label">Treatment <span
                                                ...
                                                <select name="treatment_id" id="treatment_id" class="form-control"
                                                    ...
                                                    @foreach ($treatments as $t)
                                                        <option value="{{ $t->id }}"
                                                            data-patient_treatment_id="{{ $t->patient_treatment_id }}">
                                                            {{ $t->treatment_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control" name="date" rows="3"
