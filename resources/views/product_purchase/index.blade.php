            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        <form action="{{ route('product_purchase.index') }}" method="GET" class="d-flex align-items-center gap-2">
                        ...
                        <a href="{{ route('product_purchase.create') }}" class="btn btn-sm btn-primary">➕ Add Purchase</a>
                    </div>
                </div>
