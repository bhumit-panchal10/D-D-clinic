            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('maintenance.create') }}" class="btn btn-sm btn-primary">+ Add Maintenance
                            Record</a>
                    </div>
    ...
    <div class="modal fade" id="markReceivedModal" tabindex="-1" aria-labelledby="markReceivedModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('maintenance.markAsReceived') }}">
                        @csrf
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#confirmDelete").on("click", function () {
                let id = $("#deleteid").val();
                let actionUrl = "{{ route('maintenance.destroy', ':id') }}".replace(':id', id);
