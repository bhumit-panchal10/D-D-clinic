...
$fileName = "https://getdemo.in/dental_clinic/signature/".$fileName;
// dd($fileName);
?>
                        ...
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td style="padding-top: 20px;">I <b>{{ $patient['patient'][0]['name_prefix'] }}
                                    ...
                                    myself/upon <b>{{ $patient['patient'][0]['age'] }} </b> aged 1 Y who is related to
                                    me as ............................... (mention here
                            ...
                            <tr>
                                <td style=""><img style="text-align:left;width:200px;height:100px;"
                                        src="{{ $fileName }}" alt=""></td>
                            </tr>
                            <tr>
