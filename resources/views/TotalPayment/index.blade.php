                    ...
                    <div class="col-lg-5">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <h5 class="card-title mb-0">Add Payments</h5>
                            </div>

                            <div class="card-body">

                                <form action="{{ route('TotalPayment.store') }}" method="POST">
                                    @csrf
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-sm btn-primary delete-btn"
                                                        data-id="{{ $note->id }}" data-toggle="modal"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editForm" method="POST" action="{{ route('TotalPayment.update') }}">
                        @csrf
    ...
    <script>
        $(document).ready(function() {
            $(".delete-btn").on("click", function() {
                ...
                let actionUrl = "{{ route('TotalPayment.destroy', ':id') }}".replace(':id', id);
