...
<div class="page">
    ...
    <form id="consentForm"
      action="{{ route('patient.consent.form.save', $patient->id) }}"
      method="POST">
      ...
      <hr class="my-4">
        ...
        <div class="mt-4">
            ...
            <label class="form-label fw-bold">
                Patient Signature <span class="text-danger">*</span>
            </label>
            ...
            <div class="border rounded p-2">
                ...
                <canvas id="signature-pad"
                        width="800"
                        height="180"
                        style="width:100%;height:180px;background:#fff;cursor:crosshair;">
                </canvas>
