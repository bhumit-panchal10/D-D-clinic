...
class Notes extends Model
{
    ...
    protected $fillable = ['patient_id', 'date', 'treatment_id', 'sub_treatment_id', 'comments', 'amount', 'tooth_no', 'next_appointment_date', 'discount', 'created_at', 'updated_at', 'Net_amount', 'type', 'is_completed'];
